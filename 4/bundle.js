...
/* harmony import */ var _components_footer_statistics_template_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/footer-statistics-template.js */ "./src/components/footer-statistics-template.js");
...
render(footerStatistics, Object(_components_footer_statistics_template_js__WEBPACK_IMPORTED_MODULE_9__["createFooterStatisticsTemplate"])(_components_generate_data_film_card_js__WEBPACK_IMPORTED_MODULE_0__["FILMS_CARDS_ARR"]), `beforeend`);
// ------------------------------------------------------------
let actuallyCardsArr = _components_generate_data_film_card_js__WEBPACK_IMPORTED_MODULE_0__["FILMS_CARDS_ARR"].slice(0, _components_generate_data_film_card_js__WEBPACK_IMPORTED_MODULE_0__["FILMS_CARDS_ARR"].length);
// -------------------------showMoreBtn-----------------------------------------
const showMoreBtn = document.querySelector(`.films-list__show-more`);
showMoreBtn.addEventListener(`click`, () => {
  actuallyCardsArr.splice(0, 5);
  for (let i = 0; i < CARDS_COUNT; i++) {
    render(filmsListContainer, Object(_components_film_card_template_js__WEBPACK_IMPORTED_MODULE_6__["createFilmCardTemplate"])(actuallyCardsArr[i]), `beforeend`);
...
const setDateSort = () => {
  actuallyCardsArr = _components_generate_data_film_card_js__WEBPACK_IMPORTED_MODULE_0__["FILMS_CARDS_ARR"].slice(0, _components_generate_data_film_card_js__WEBPACK_IMPORTED_MODULE_0__["FILMS_CARDS_ARR"].length);
  const companare = (a, b) => {
